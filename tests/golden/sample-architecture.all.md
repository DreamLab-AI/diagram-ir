...
- source canvas: 400×80 px (aspect 5.00)
- nodes: 2 total / 2 drawable / 0 containers, depth 0
- edges: 1 (1 labeled, 0 dangling), cycle: False
- shapes: {'table': 2}
- type candidates: er, tree, architecture
- budget: nodes ok (max 9), edges ok (max 12)
- hubs (focal candidates): customers(1), orders(1)
- entry points: customers
- terminals: orders
...
| id | label | shape | depth | parent | deg | box |
|---|---|---|---|---|---|---|
| t1 | customers | table | 0 | 1 | 0/1 | 0,0 160×80 |
| t2 | orders | table | 0 | 1 | 1/0 | 240,0 160×80 |
